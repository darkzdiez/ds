...
| -------------------------------------------------------------------*/
	...
	if ($_SERVER['REMOTE_ADDR'] == '::1' OR $_SERVER['REMOTE_ADDR'] == '127.0.0.1') {
		$config['img_path'] = 'http://localhost/appgob/system/webgob/media/test'; // Relative to domain name
		$config['upload_path'] = __DIR__ . '/../../../../../system/webgob/media/test'; // Physical path. [Usually works fine like this]
	} else {
		$config['img_path'] = 'http://yaracuy.gob.ve/appgob/system/webgob/media/test'; // Relative to domain name
		$config['upload_path'] = __DIR__ . '/../../../../../system/webgob/media/test'; // Physical path. [Usually works fine like this]
	}
