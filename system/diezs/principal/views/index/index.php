      ...
      <div class="row marketing">
        <div class="col-xs-6">
          <h4><i class="glyphicon glyphicon-ok"></i> HTML5</h4>
          <p>Maquetación semántica, generacion de graficos mediante <code>&lt;canvas&gt;</code>, uso de multiples APIs.</p>

          <h4><i class="glyphicon glyphicon-ok"></i> CSS3</h4>
          <p>Aplicación de estilos minimizando el uso de imágenes, logrando aplicaciones web mas ligeras, agradables y adaptables.</p>
