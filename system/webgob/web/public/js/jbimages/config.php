...
| 
| -------------------------------------------------------------------*/
	require __DIR__ . '/../../../../../system/webgob/web/config.php';
	exit('1: '.PATH_SYSTEM.' else: '.DIR_PATH_SYSTEM);

	$config['img_path'] = PATH_SYSTEM . '/media/test'; // Relative to domain name
	$config['upload_path'] = DIR_PATH_SYSTEM . '/media/test'; // Physical path. [Usually works fine like this]
