<form id="formCargarObservacion" class="form-horizontal ajaxForm" enctype="multipart/form-data" method="post" action="<?php print PATH_NAV; ?>orden/observacionguardar/<?php print $this->idOrden; ?>">
	<div class="bs-docs-example">
		<div class="descriptionForm">CREAR UNA OBSERVACIÓN:</div>
