<form id="formCargarNovedad" class="form-horizontal ajaxForm" enctype="multipart/form-data" method="post" action="<?php print PATH_NAV; ?>orden/novedadguardar/<?php print $this->idOrden; ?>">
	<div class="bs-docs-example">
		<div class="descriptionForm">CREAR UNA NOVEDAD:</div>
...
<div id="cargarimagen" style="display: none">
    <div class="bs-docs-example">
        <div class="descriptionForm">NOVEDAD:</div>
        <p id="textoEnviado"></p>
    </div>
